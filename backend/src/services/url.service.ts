...
export async function getByShortCode(shortCode: string) {
...
export async function registerHit(shortUrlId: number, meta: { referrer?: string; userAgent?: string; ip?: string }) {
  await pool.query(
